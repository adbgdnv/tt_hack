...
|---|---:|
| Истец против ответчика | 160 (80%) |
| Структура баланса: капитал против обязательств | 134 (67%) |
| Выручка и активы по годам (≥2 года) | 121 (61%) |
| Исполнительные производства: активные против завершённых | 96 (48%) |
