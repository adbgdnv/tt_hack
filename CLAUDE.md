...
- Два независимых светофора: `baseInfo.riskLevel` (LOW/MEDIUM/HIGH) и `zskRiskLevel`
  (GREEN/YELLOW/RED). Оба считаются по **банковским транзакционным** данным — переводы
  физлицам, обналичивание — и **не учитывают суды**. Расхождение с открытыми данными
  это конструкция, а не баг.
...
- Шум к сигналу в отчёте — **13,4 : 1** (1529 позитивных факторов против 114 негативных).
