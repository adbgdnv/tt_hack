...
**Path note.** Read canon via `.claude/Next-Move-Theory-Canon/...` (public layout). If not found, retry with a `1-` prefix — `.claude/1-Next-Move-Theory-Canon/...` (Internal layout; the source repo numbers folders, the public mirror strips the prefix).
